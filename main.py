...
st.markdown('<h1 style="border: 2px solid white; padding: 10px; text-align: center; background-color:white, text-color:black">Summarization Application</h1>', unsafe_allow_html=True)
